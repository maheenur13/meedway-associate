...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-[11px] font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 disabled:pointer-events-none disabled:opacity-50 [&>svg]:transition-transform [&>svg]:duration-200 hover:[&>svg:last-child]:translate-x-0.5",
  {
    variants: {
      variant: {
        primary:
